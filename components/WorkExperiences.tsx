  ...
  return (
    <section className="">
      ...
      <div className="max-w-6xl mx-auto mt-12  grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="w-full bg-linear-to-br from-white/20 to-black/20 shadow-xl shadow-white/5 rounded-2xl overflow-hidden">
          {/* Image */}
          <div className="relative w-full h-40 sm:h-48">
            <Image
              src="https://res.cloudinary.com/dnqq3putc/image/upload/v1767880267/nexacore_rnm16h.jpg"
              alt="Nexa Core logo"
              fill
